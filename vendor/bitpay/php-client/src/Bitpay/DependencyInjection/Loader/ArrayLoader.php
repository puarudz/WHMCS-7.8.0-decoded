    ...
    public function load($resource, $type = null)
    {
        ...
        foreach (array_keys($resource) as $namespace) {
            ...
            if (!$this->container->hasExtension($namespace)) {
                ...
                throw new InvalidArgumentException(sprintf('There is no extension able to load the configuration for "%s". Looked for namespace "%s", found %s', $namespace, $namespace, $extensionNamespaces ? sprintf('"%s"', implode('", "', $extensionNamespaces)) : 'none'));
            }
        }
        // Set Paramters
