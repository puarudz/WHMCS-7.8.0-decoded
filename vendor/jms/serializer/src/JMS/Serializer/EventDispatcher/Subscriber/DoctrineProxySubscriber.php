...
class DoctrineProxySubscriber implements EventSubscriberInterface
{
    ...
    public function onPreSerialize(PreSerializeEvent $event)
    {
        ...
        if ($this->skipVirtualTypeInit && $virtualType || !$object instanceof Proxy && !$object instanceof ORMProxy) {
            return;
        }
    ...
    {
        return array(array('event' => 'serializer.pre_serialize', 'method' => 'onPreSerializeTypedProxy'), array('event' => 'serializer.pre_serialize', 'method' => 'onPreSerialize'));
    }
}
