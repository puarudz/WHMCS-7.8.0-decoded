...
class Serializer implements SerializerInterface, ArrayTransformerInterface
{
    ...
    public function serialize($data, $format, SerializationContext $context = null)
    {
        ...
        return $this->serializationVisitors->get($format)->map(function (VisitorInterface $visitor) use($context, $data, $format) {
    ...
    public function deserialize($data, $type, $format, DeserializationContext $context = null)
    {
        ...
        return $this->deserializationVisitors->get($format)->map(function (VisitorInterface $visitor) use($context, $data, $format, $type) {
    ...
    public function toArray($data, SerializationContext $context = null)
    {
        ...
        return $this->serializationVisitors->get('json')->map(function (JsonSerializationVisitor $visitor) use($context, $data) {
            $type = $context->getInitialType() !== null ? $this->typeParser->parse($context->getInitialType()) : null;
