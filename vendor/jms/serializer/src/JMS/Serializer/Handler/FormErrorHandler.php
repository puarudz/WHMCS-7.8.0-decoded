...
class FormErrorHandler implements SubscribingHandlerInterface
{
    ...
    public static function getSubscribingMethods()
    {
        ...
        foreach (array('xml', 'json', 'yml') as $format) {
            $methods[] = array('direction' => GraphNavigator::DIRECTION_SERIALIZATION, 'type' => 'Symfony\\Component\\Form\\Form', 'format' => $format);
            $methods[] = array('direction' => GraphNavigator::DIRECTION_SERIALIZATION, 'type' => 'Symfony\\Component\\Form\\FormError', 'format' => $format);
        }
        return $methods;
    }
