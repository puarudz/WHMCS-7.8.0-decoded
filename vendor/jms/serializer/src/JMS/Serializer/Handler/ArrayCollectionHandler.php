...
class ArrayCollectionHandler implements SubscribingHandlerInterface
{
    ...
    public static function getSubscribingMethods()
    {
        ...
        $collectionTypes = array('ArrayCollection', 'Doctrine\\Common\\Collections\\ArrayCollection', 'Doctrine\\ORM\\PersistentCollection', 'Doctrine\\ODM\\MongoDB\\PersistentCollection', 'Doctrine\\ODM\\PHPCR\\PersistentCollection');
        foreach ($collectionTypes as $type) {
            foreach ($formats as $format) {
                $methods[] = array('direction' => GraphNavigator::DIRECTION_SERIALIZATION, 'type' => $type, 'format' => $format, 'method' => 'serializeCollection');
                $methods[] = array('direction' => GraphNavigator::DIRECTION_DESERIALIZATION, 'type' => $type, 'format' => $format, 'method' => 'deserializeCollection');
            }
        }
        return $methods;
    }
