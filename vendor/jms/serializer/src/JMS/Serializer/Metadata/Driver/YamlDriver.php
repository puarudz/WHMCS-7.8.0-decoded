    ...
    protected function loadMetadataFromFile(\ReflectionClass $class, $file)
    {
        ...
        if (!$excludeAll) {
            ...
            foreach ($propertiesMetadata as $pName => $pMetadata) {
                $isExclude = false;
                $isExpose = $pMetadata instanceof VirtualPropertyMetadata || $pMetadata instanceof ExpressionPropertyMetadata || isset($config['properties']) && array_key_exists($pName, $config['properties']);
