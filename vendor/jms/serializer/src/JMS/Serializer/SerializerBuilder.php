...
class SerializerBuilder
{
    ...
    public function addDefaultSerializationVisitors()
    {
        ...
        $this->visitorsAdded = true;
        $this->serializationVisitors->setAll(array('xml' => new XmlSerializationVisitor($this->propertyNamingStrategy, $this->getAccessorStrategy()), 'yml' => new YamlSerializationVisitor($this->propertyNamingStrategy, $this->getAccessorStrategy()), 'json' => new JsonSerializationVisitor($this->propertyNamingStrategy, $this->getAccessorStrategy())));
        return $this;
    }
    public function addDefaultDeserializationVisitors()
    {
        $this->initializePropertyNamingStrategy();
        $this->visitorsAdded = true;
        $this->deserializationVisitors->setAll(array('xml' => new XmlDeserializationVisitor($this->propertyNamingStrategy), 'json' => new JsonDeserializationVisitor($this->propertyNamingStrategy)));
        return $this;
    }
    /**
    ...
    public function setSerializationContextFactory($serializationContextFactory)
    {
        if ($serializationContextFactory instanceof SerializationContextFactoryInterface) {
            ...
            $this->serializationContextFactory = new CallableSerializationContextFactory($serializationContextFactory);
        } else {
    ...
    public function setDeserializationContextFactory($deserializationContextFactory)
    {
        if ($deserializationContextFactory instanceof DeserializationContextFactoryInterface) {
            ...
            $this->deserializationContextFactory = new CallableDeserializationContextFactory($deserializationContextFactory);
        } else {
    ...
    public function build()
    {
        ...
        $serializer = new Serializer($metadataFactory, $this->handlerRegistry, $this->objectConstructor ?: new UnserializeObjectConstructor(), $this->serializationVisitors, $this->deserializationVisitors, $this->eventDispatcher, null, $this->expressionEvaluator);
