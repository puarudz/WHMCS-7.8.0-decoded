...
class ExtensionCollection
{
    ...
    protected function validateClassImplementation($class)
    {
        ...
        $valid_implementation = is_a($class, $this->basic_interface, $str_class) || is_a($class, $this->dynamic_interface, $str_class);
        if (!$valid_implementation) {
            throw new \Exception('Class must implement either ' . $this->basic_interface . ' or ' . $this->dynamic_interface);
        }
    }
    /**
