...
class ExpressionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array('{foo}', Expression::TYPE_REGEX), array('/foo/', Expression::TYPE_REGEX), array('foo', Expression::TYPE_GLOB), array('foo*', Expression::TYPE_GLOB));
    }
    public function getCaseSensitiveData()
    {
        return array(array('{foo}m', true), array('/foo/i', false), array('foo*', true));
    }
    public function getRegexRenderingData()
    {
        return array(array('{foo}m', 'foo'), array('/foo/i', 'foo'));
    }
}
