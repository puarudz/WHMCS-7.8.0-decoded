...
class SortableIteratorTest extends RealIteratorTestCase
{
    ...
    {
        $sortByName = array('.bar', '.foo', '.foo/.bar', '.foo/bar', '.git', 'foo', 'foo bar', 'foo/bar.tmp', 'test.php', 'test.py', 'toto', 'toto/.git');
        ...
        $sortByAccessedTime = array(
            ...
            array('.git', '.foo', '.foo/.bar', '.foo/bar', 'test.py', 'foo', 'toto', 'toto/.git', 'foo bar'),
