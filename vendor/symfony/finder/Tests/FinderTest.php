...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testIn()
    {
        ...
        $expected = array(self::$tmpDir . DIRECTORY_SEPARATOR . 'test.php', __DIR__ . DIRECTORY_SEPARATOR . 'BsdFinderTest.php', __DIR__ . DIRECTORY_SEPARATOR . 'FinderTest.php', __DIR__ . DIRECTORY_SEPARATOR . 'GnuFinderTest.php', __DIR__ . DIRECTORY_SEPARATOR . 'PhpFinderTest.php', __DIR__ . DIRECTORY_SEPARATOR . 'GlobTest.php');
    ...
    {
        $locations = array(self::$tmpDir . '/', self::$tmpDir . '/toto/');
    ...
    {
        $locations = array(__DIR__ . '/Fixtures/one', self::$tmpDir . DIRECTORY_SEPARATOR . 'toto');
        $finder = $this->buildFinder();
        $finder->in($locations)->depth('< 10')->name('*.neon');
        $expected = array(__DIR__ . '/Fixtures/one' . DIRECTORY_SEPARATOR . 'b' . DIRECTORY_SEPARATOR . 'c.neon', __DIR__ . '/Fixtures/one' . DIRECTORY_SEPARATOR . 'b' . DIRECTORY_SEPARATOR . 'd.neon');
    ...
    public function testAdaptersOrdering()
    {
        ...
        $this->assertEquals(array('c', 'e', 'a', 'd', 'b'), array_map(function (AdapterInterface $adapter) {
    ...
    public function getTestPathData()
    {
        ...
        )), array('/^with space\\//', 'foobar', array('with space' . DIRECTORY_SEPARATOR . 'foo.txt')));
    }
