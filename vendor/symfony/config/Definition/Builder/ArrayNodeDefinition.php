...
class ArrayNodeDefinition extends NodeDefinition implements ParentNodeDefinitionInterface
{
    ...
    {
        $this->addDefaultsIfNotSet()->treatFalseLike(array('enabled' => false))->treatTrueLike(array('enabled' => true))->treatNullLike(array('enabled' => true))->children()->booleanNode('enabled')->defaultTrue();
        return $this;
    }
    /**
