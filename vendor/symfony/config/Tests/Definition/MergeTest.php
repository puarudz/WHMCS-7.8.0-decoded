...
class MergeTest extends TestCase
{
    ...
    public function testUnsetKey()
    {
        ...
        $a = array('foo' => 'bar', 'unsettable' => array('foo' => 'a', 'bar' => 'b'), 'unsetted' => false);
        $b = array('foo' => 'moo', 'bar' => 'b', 'unsettable' => false, 'unsetted' => array('a', 'b'));
        $this->assertEquals(array('foo' => 'moo', 'bar' => 'b', 'unsettable' => false, 'unsetted' => array('a', 'b')), $tree->merge($a, $b));
    }
    /**
    ...
    public function testDoesNotAllowNewKeysInSubsequentConfigs()
    {
        ...
        $a = array('test' => array('a' => array('value' => 'foo')));
        $b = array('test' => array('b' => array('value' => 'foo')));
        $tree->merge($a, $b);
    }
    public function testPerformsNoDeepMerging()
    {
        ...
        $a = array('no_deep_merging' => array('foo' => 'a', 'bar' => 'b'));
        $b = array('no_deep_merging' => array('c' => 'd'));
        $this->assertEquals(array('no_deep_merging' => array('c' => 'd')), $tree->merge($a, $b));
    }
