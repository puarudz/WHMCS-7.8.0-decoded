...
class FinalizationTest extends TestCase
{
    public function testUnsetKeyWithDeepHierarchy()
    {
        ...
        $a = array('level1' => array('level2' => array('somevalue' => 'foo', 'anothervalue' => 'bar'), 'level1_scalar' => 'foo'));
        $b = array('level1' => array('level2' => false));
        $this->assertEquals(array('level1' => array('level1_scalar' => 'foo')), $this->process($tree, array($a, $b)));
    }
