...
class QuestionHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array('', true), array('', false, false), array('y', true), array('yes', true), array('n', false), array('no', false));
    }
    ...
    {
        $possibleChoices = array('My environment 1', 'My environment 2', 'My environment 3');
        $dialog = new QuestionHelper();
    ...
    {
        return array(array(0, 'My environment 1'), array(1, 'My environment 2'), array(2, 'My environment 3'), array('My environment 1', 'My environment 1'), array('My environment 2', 'My environment 2'), array('My environment 3', 'My environment 3'));
    }
    /**
    ...
    {
        $possibleChoices = array('0' => 'No environment', '1' => 'My environment 1', 'env_2' => 'My environment 2', 3 => 'My environment 3');
        $dialog = new QuestionHelper();
        $dialog->setInputStream($this->getInputStream($providedAnswer . "\n"));
        $helperSet = new HelperSet(array(new FormatterHelper()));
        $dialog->setHelperSet($helperSet);
    ...
    {
        return array(array('0', '0'), array('No environment', '0'), array('1', '1'), array('env_2', 'env_2'), array(3, '3'), array('My environment 1', '1'));
    }
    /**
    ...
    {
        return array(array('env_1', 'env_1'), array('env_2', 'env_2'), array('env_3', 'env_3'), array('My environment 1', 'env_1'));
    }
