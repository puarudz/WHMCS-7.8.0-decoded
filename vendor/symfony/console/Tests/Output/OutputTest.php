...
class OutputTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array('<info>foo</info>', Output::OUTPUT_RAW, "<info>foo</info>\n"), array('<info>foo</info>', Output::OUTPUT_PLAIN, "foo\n"));
    }
