...
class SymfonyStyle extends OutputStyle
{
    ...
    {
        $this->autoPrependBlock();
        $this->writeln(array(sprintf('<comment>%s</>', $message), sprintf('<comment>%s</>', str_repeat('=', Helper::strlenWithoutDecoration($this->getFormatter(), $message)))));
        $this->newLine();
    }
    /**
     * {@inheritdoc}
    ...
    public function table(array $headers, array $rows)
    {
        array_walk_recursive($headers, function (&$value) {
            if ($value instanceof TableCell) {
                $value = new TableCell(sprintf('<info>%s</>', $value), array('colspan' => $value->getColspan(), 'rowspan' => $value->getRowspan()));
            } else {
