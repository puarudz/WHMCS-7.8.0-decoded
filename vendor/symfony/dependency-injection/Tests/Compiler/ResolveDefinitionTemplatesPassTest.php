...
class ResolveDefinitionTemplatesPassTest extends \PHPUnit_Framework_TestCase
{
    public function testProcess()
    {
        ...
        $container->setDefinition('child', new DefinitionDecorator('parent'))->replaceArgument(0, 'a')->setProperty('foo', 'bar')->setClass('bar');
    ...
    public function testProcessAppendsMethodCallsAlways()
    {
        ...
        $container->setDefinition('child', new DefinitionDecorator('parent'))->addMethodCall('bar', array('foo'));
        $this->process($container);
        $def = $container->getDefinition('child');
        $this->assertEquals(array(array('foo', array('bar')), array('bar', array('foo'))), $def->getMethodCalls());
    }
    ...
    public function testProcessDoesNotDropShared()
    {
        ...
        $container->setDefinition('child', new DefinitionDecorator('parent'))->setShared(false);
        $this->process($container);
        $def = $container->getDefinition('child');
    ...
    {
        $container = new ContainerBuilder();
        $container->register('parent', 'foo')->setArguments(array('foo', 'bar', 'c'));
        $container->setDefinition('child2', new DefinitionDecorator('child1'))->replaceArgument(1, 'b');
        $container->setDefinition('child1', new DefinitionDecorator('parent'))->replaceArgument(0, 'a');
        $this->process($container);
    ...
    public function testSetLazyOnServiceHasParent()
    {
        ...
        $container->setDefinition('child1', new DefinitionDecorator('parent'))->setLazy(true);
        $this->process($container);
    ...
    public function testSetAutowiredOnServiceHasParent()
    {
        $container = new ContainerBuilder();
        $container->register('parent', 'stdClass');
        $container->setDefinition('child1', new DefinitionDecorator('parent'))->setAutowired(true);
        $this->process($container);
    ...
    public function testDeepDefinitionsResolving()
    {
        ...
        $container->register('sibling', 'siblingClass')->setConfigurator(new DefinitionDecorator('parent'), 'foo')->setFactory(array(new DefinitionDecorator('parent'), 'foo'))->addArgument(new DefinitionDecorator('parent'))->setProperty('prop', new DefinitionDecorator('parent'))->addMethodCall('meth', array(new DefinitionDecorator('parent')));
        $this->process($container);
    ...
    public function testSetDecoratedServiceOnServiceHasParent()
    {
        $container = new ContainerBuilder();
        $container->register('parent', 'stdClass');
        $container->setDefinition('child1', new DefinitionDecorator('parent'))->setDecoratedService('foo', 'foo_inner', 5);
        $this->process($container);
    ...
    public function testDecoratedServiceCanOverwriteDeprecatedParentStatus()
    {
        $container = new ContainerBuilder();
        $container->register('deprecated_parent')->setDeprecated(true);
        $container->setDefinition('decorated_deprecated_parent', new DefinitionDecorator('deprecated_parent'))->setDeprecated(false);
        $this->process($container);
    ...
    public function testProcessMergeAutowiringTypes()
    {
        ...
        $container->setDefinition('child', new DefinitionDecorator('parent'))->addAutowiringType('Bar');
        $this->process($container);
