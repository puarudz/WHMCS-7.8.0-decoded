...
class ExtensionCompilerPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcess()
    {
        ...
        $this->container->expects($this->any())->method('getExtensions')->will($this->returnValue(array($extension1, $extension2, $extension3, $extension4)));
        $this->pass->process($this->container);
    }
    private function createExtensionMock($hasInlineCompile)
    {
        return $this->getMockBuilder('Symfony\\Component\\DependencyInjection\\' . ($hasInlineCompile ? 'Compiler\\CompilerPassInterface' : 'Extension\\ExtensionInterface'))->getMock();
    }
}
