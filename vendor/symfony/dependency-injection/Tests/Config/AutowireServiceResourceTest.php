...
class AutowireServiceResourceTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->resource = new AutowireServiceResource($this->class, $this->file, array());
    }
    ...
    {
        $oldResource = new AutowireServiceResource($this->class, $this->file, array('will_be_different'));
    ...
    {
        $resource = new AutowireServiceResource('Some\\Non\\Existent\\Class', $this->file, array());
