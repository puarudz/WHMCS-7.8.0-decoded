...
{
    private static $handlers = array('DateTime' => 'PhpCollection\\ObjectBasicsHandler\\DateTimeHandler');
    ...
    public static function getHandler($className)
    {
        ...
        throw new \LogicException(sprintf('Unknown handler type ("%s") for class "%s" - should never be reached.', gettype(self::$handlers[$className]), $className));
    }
