...
class Bitbucket
{
    ...
    private function requestAccessToken($originUrl)
    {
        try {
            ...
            $json = $this->remoteFilesystem->getContents($originUrl, $apiUrl, false, array('retry-auth-failure' => false, 'http' => array('method' => 'POST', 'content' => 'grant_type=client_credentials')));
    ...
    public function authorizeOAuthInteractively($originUrl, $message = null)
    {
        ...
        $consumer = array("consumer-key" => $consumerKey, "consumer-secret" => $consumerSecret);
