...
abstract class VcsDownloader implements DownloaderInterface, ChangeReportInterface
{
     ...
     */
    protected abstract function doDownload(PackageInterface $package, $path, $url);
    /**
     ...
     * @param string           $url     package url
     */
    protected abstract function doUpdate(PackageInterface $initial, PackageInterface $target, $path, $url);
    /**
