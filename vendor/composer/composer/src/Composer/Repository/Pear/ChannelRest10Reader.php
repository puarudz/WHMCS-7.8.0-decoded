...
class ChannelRest10Reader extends BaseChannelReader
{
    ...
    private function readPackage($baseUrl, $packageName)
    {
        ...
        return new PackageInfo($channelName, $packageName, $license, $shortDescription, $description, $this->readPackageReleases($baseUrl, $packageName));
    }
    /**
    ...
    private function readPackageReleases($baseUrl, $packageName)
    {
        ...
        try {
            ...
            foreach ($xml->xpath('ns:r') as $node) {
                ...
                try {
                    $result[$releaseVersion] = new ReleaseInfo($releaseStability, $this->readPackageReleaseDependencies($baseUrl, $packageName, $releaseVersion));
