...
class VersionParser
{
    ...
    public function parseConstraints($constraints)
    {
        ...
        } elseif (2 === count($orGroups) && $orGroups[0] instanceof MultiConstraint && $orGroups[1] instanceof MultiConstraint && 2 === count($orGroups[0]->getConstraints()) && 2 === count($orGroups[1]->getConstraints()) && ($a = (string) $orGroups[0]) && substr($a, 0, 3) === '[>=' && false !== ($posA = strpos($a, '<', 4)) && ($b = (string) $orGroups[1]) && substr($b, 0, 3) === '[>=' && false !== ($posB = strpos($b, '<', 4)) && substr($a, $posA + 2, -1) === substr($b, 4, $posB - 5)) {
