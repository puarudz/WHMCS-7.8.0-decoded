...
class Calendar
{
    ...
    {
        static $cache = array();
        static $convert = array('d' => 'dd', 'D' => 'EE', 'j' => 'd', 'l' => 'EEEE', 'N' => 'P', 'S' => 'PPP', 'w' => 'PP', 'z' => 'PPPP', 'W' => 'ww', 'F' => 'MMMM', 'm' => 'MM', 'M' => 'MMM', 'n' => 'M', 't' => 'PPPPP', 'L' => 'PPPPPP', 'o' => 'YYYY', 'Y' => 'yyyy', 'y' => 'yy', 'a' => 'PPPPPPP', 'A' => 'a', 'B' => 'PPPPPPPP', 'g' => 'h', 'G' => 'H', 'h' => 'hh', 'H' => 'HH', 'i' => 'mm', 's' => 'ss', 'e' => 'VV', 'I' => 'I', 'O' => 'Z', 'P' => 'ZZZZZ', 'T' => 'z', 'Z' => 'PPPPPPPPPPP', 'c' => 'yyyy-MM-ddTHH:mm:ssZZZZZ', 'r' => 'PPPPPPPPPPPP', 'U' => 'U', 'u' => 'PPPPPPPPP', 'I' => 'PPPPPPPPPP', 'U' => 'PPPPPPPPPPPPP');
        if (!is_string($format)) {
            return '';
        }
    ...
    protected static function getDatetimeFormatReal($width, $locale = '', $overrideDateFormat = '', $overrideTimeFormat = '')
    {
        ...
        return sprintf($data[$wholeWidth], isset($overrideTimeFormat[0]) ? $overrideTimeFormat : static::getTimeFormat($timeWidth, $locale), isset($overrideDateFormat[0]) ? $overrideDateFormat : static::getDateFormat($dateWidth, $locale));
    }
    /**
    ...
    public static function formatDate($value, $width, $locale = '')
    {
        ...
        return static::format($value, static::getDateFormat($width, $locale), $locale);
    }
    /**
    ...
    {
        return static::formatDate(static::toDateTime($value, $toTimezone), $width, $locale);
    }
    /**
     * Format a time.
     *
    ...
    {
        return static::format($value, static::getTimeFormat($width, $locale), $locale);
    }
    /**
    ...
    {
        return static::formatTime(static::toDateTime($value, $toTimezone), $width, $locale);
    }
    /**
     * Format a date/time.
     *
    ...
    public static function formatDatetime($value, $width, $locale = '')
    {
        ...
        return static::format($value, static::getDatetimeFormatReal($width, $locale, $overrideDateFormat), $locale);
    }
    /**
    ...
    {
        return static::formatDatetime(static::toDateTime($value, $toTimezone), $width, $locale);
    }
    /**
    ...
    {
        return static::format(static::toDateTime($value, $toTimezone), $format, $locale);
    }
    /**
