...
class MenuManipulator
{
    ...
    {
        return array('primary' => $this->slice($item, 0, $length), 'secondary' => $this->slice($item, $length));
    }
    /**
        ...
        foreach ($subItem as $key => $value) {
            switch (true) {
                ...
                case is_integer($key) && is_string($value):
                    $value = array('label' => (string) $value, 'uri' => null, 'item' => null);
                    break;
                case is_scalar($value):
                    $value = array('label' => (string) $key, 'uri' => (string) $value, 'item' => null);
                    break;
                case null === $value:
                    $value = array('label' => (string) $key, 'uri' => null, 'item' => null);
                    break;
                default:
