...
class MenuExtension extends \Twig_Extension
{
    ...
    {
        return array(new \Twig_SimpleFunction('knp_menu_get', array($this, 'get')), new \Twig_SimpleFunction('knp_menu_render', array($this, 'render'), array('is_safe' => array('html'))), new \Twig_SimpleFunction('knp_menu_get_breadcrumbs_array', array($this, 'getBreadcrumbsArray')));
    }
    public function getFilters()
    {
        return array(new \Twig_SimpleFilter('knp_menu_as_string', array($this, 'pathAsString')));
    }
    public function getTests()
    {
        return array(new \Twig_SimpleTest('knp_menu_current', array($this, 'isCurrent')), new \Twig_SimpleTest('knp_menu_ancestor', array($this, 'isAncestor')));
    }
    /**
