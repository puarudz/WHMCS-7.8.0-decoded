...
?>
    ...
    <ul class="search-for-help">
      <li>
        <a target="_blank" href="https://google.com/search?q=<?php 
echo urlencode(implode('\\', $name) . ' ' . $message);
?>" title="Search for help on Google.">
      ...
      <li>
        <a target="_blank" href="https://stackoverflow.com/search?q=<?php 
echo urlencode(implode('\\', $name) . ' ' . $message);
...
?></span>
    <button id="copy-button" class="clipboard" data-clipboard-text="<?php 
echo $tpl->escape($plain_exception);
