...
class PhpTimeConverter implements TimeConverterInterface
{
    ...
    public function calculateTime($seconds, $microSeconds)
    {
        ...
        $uuidTime = $seconds * 10000000 + $microSeconds * 10 + 1.22192928E+17;
        return array('low' => sprintf('%08x', $uuidTime & 4294967295.0), 'mid' => sprintf('%04x', $uuidTime >> 32 & 0xffff), 'hi' => sprintf('%04x', $uuidTime >> 48 & 0xfff));
    }
}
