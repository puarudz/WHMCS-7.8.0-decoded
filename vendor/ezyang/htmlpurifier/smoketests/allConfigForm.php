...
$printer_config_form = new HTMLPurifier_Printer_ConfigForm('config', 'http://htmlpurifier.org/live/configdoc/plain.html#%s');
...
<textarea name="html" style="width:100%" rows="15"><?php 
echo htmlspecialchars($html);
?></textarea>
</td><td style="width:50%">
<textarea name="result" style="width:100%" rows="15"><?php 
echo htmlspecialchars($purified);
?></textarea>
</td></tr>
</table>
<input type="submit" />
