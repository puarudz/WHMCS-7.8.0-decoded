    ...
    public function check($element, $schema = null, $path = null, $i = null)
    {
        ...
        switch ($schema->format) {
            ...
            case 'time':
                ...
                break;
            case 'date-time':
                if (!$this->validateDateTime($element, 'Y-m-d\\TH:i:s\\Z') && !$this->validateDateTime($element, 'Y-m-d\\TH:i:s.u\\Z') && !$this->validateDateTime($element, 'Y-m-d\\TH:i:sP') && !$this->validateDateTime($element, 'Y-m-d\\TH:i:sO')) {
