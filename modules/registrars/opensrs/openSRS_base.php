...
class openSRS_base extends PEAR
{
    ...
    function _log($type, $data)
    {
        ...
        $temp = sprintf("[ %s%s ]\n", strtoupper($types[$type]), $type != 'i' && $this->_CBC ? ' - ' . $this->crypt_type . ' ENCRYPTED' : '');
        ob_start();
        print_r($data);
