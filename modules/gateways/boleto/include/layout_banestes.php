...
<td class=cpt width=63 valign=bottom><div align=center><font class=bc><?php 
echo $dadosboleto["codigo_banco_com_dv"];
?></font></div></td><td width=3 valign=bottom><img height=22 src=imagens/3.gif width=2 border=0></td><td class=ld align=right width=497 valign=bottom><span class=ld> 
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.gif width=1 border=0></td><td class=cp valign=top width=126 height=12> 
  <span class="campo">
  <?php 
echo $dadosboleto["agencia"];
?>&nbsp;/&nbsp;
  <?php 
echo $dadosboleto["conta"];
?>
  </span></td>
...
?><br><br><br>
CHAVE ASBACE:&nbsp;&nbsp;<?php 
echo substr($dadosboleto["chave_asbace"], 0, 5);
?>&nbsp;
<?php 
echo substr($dadosboleto["chave_asbace"], 5, 5);
?>&nbsp;
<?php 
echo substr($dadosboleto["chave_asbace"], 10, 5);
?>&nbsp;
<?php 
echo substr($dadosboleto["chave_asbace"], 15, 5);
?>&nbsp;
<?php 
echo substr($dadosboleto["chave_asbace"], 20, 5);
?>
</FONT><br>
</span></td>
...
mecânica</div></TD></TR><TR><TD class=ct  colspan=3 ></TD></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 width=666 border=0><TBODY><TR><TD vAlign=bottom align=left height=50><?php 
