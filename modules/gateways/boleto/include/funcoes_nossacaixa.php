...
function digitoVerificador_nossonumero($numero, $conta, $dv, $agencia, $modalidade)
{
    ...
    for ($i = strlen($numext); $i > 0; $i--) {
        ...
        if ($i == 14) {
            ...
            if ($i == 1 || $i == 5 || $i == 9 || $i == 13 || $i == 15 || $i == 19 || $i == 23) {
                $n = 3;
            } else {
                if ($i == 2 || $i == 6 || $i == 10 || $i == 16 || $i == 20) {
                    $n = 1;
                } else {
                    if ($i == 4 || $i == 8 || $i == 12 || $i == 18 || $i == 22) {
                        $n = 7;
                    } else {
                        if ($i == 3 || $i == 7 || $i == 11 || $i == 17 || $i == 21) {
                            $n = 9;
                        }
                    }
                }
...
function fbarcode($valor)
{
    ...
    //Desenho da barra
    //Guarda inicial
    ?><img src=imagens/p.gif width=<?php 
    echo $fino;
    ?> height=<?php 
    echo $altura;
    ?> border=0><img
src=imagens/b.gif width=<?php 
    echo $fino;
    ?> height=<?php 
    echo $altura;
    ?> border=0><img
src=imagens/p.gif width=<?php 
    echo $fino;
    ?> height=<?php 
    echo $altura;
    ?> border=0><img
