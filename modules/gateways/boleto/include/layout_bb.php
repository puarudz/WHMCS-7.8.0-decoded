...
echo $dadosboleto["identificacao"];
?> <?php 
echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '';
?></h1>
            <address><?php 
    ...
    <div id="boleto">
        ...
        <tr>
            <td class="field_cod_banco">
                <div class="field_cod_banco"><?php 
echo $dadosboleto["codigo_banco_com_dv"];
?></div>
            </td>
            <td class="linha_digitavel"><?php 
...
?></td>
        ...
        <tr class="campos">
            <td class="cedente"><?php 
echo $dadosboleto["cedente"];
?>&nbsp;</td>
            <td class="ag_cod_cedente"><?php 
echo $dadosboleto["agencia_codigo"];
?> &nbsp;</td>
            <td class="especie"><?php 
echo $dadosboleto["especie"];
?>&nbsp;</td>
            <TD class="qtd"><?php 
echo $dadosboleto["quantidade"];
?>&nbsp;</td>
            <TD class="nosso_numero"><?php 
...
?>&nbsp;</td>
        ...
        <tr class="campos">
            <td class="num_doc"><?php 
echo $dadosboleto["numero_documento"];
?></td>
            <td class="contrato"><?php 
echo $dadosboleto["contrato"];
?></td>
            <td class="cpf_cei_cnpj"><?php 
echo $dadosboleto["cpf_cnpj"];
?></td>
            <td class="vencimento"><?php 
...
?></td>
        ...
        <tr class="campos">
            <td class="cedente2"><?php 
echo $dadosboleto["cedente"];
?></td>
            <td class="ag_cod_cedente2"><?php 
echo $dadosboleto["agencia_codigo"];
?></td>
        </tr>
        </tbody>
        ...
        <tr class="campos">
            <td class="data_doc"><?php 
echo $dadosboleto["data_documento"];
?></td>
            <td class="num_doc2"><?php 
echo $dadosboleto["numero_documento"];
?></td>
            <td class="especie_doc"><?php 
echo $dadosboleto["especie_doc"];
?></td>
            <td class="aceite"><?php 
echo $dadosboleto["aceite"];
?></td>
            <td class="data_process"><?php 
echo $dadosboleto["data_processamento"];
?></td>
            <td class="nosso_numero2"><?php 
echo $dadosboleto["nosso_numero"];
?></td>
        </tr>
        </tbody>
        ...
        <tr class="campos">
            ...
            <td class="carteira"><?php 
echo $dadosboleto["carteira"];
?> <?php 
echo isset($dadosboleto["variacao_carteira"]) ? $dadosboleto["variacao_carteira"] : '&nbsp;';
?></td>
            <td class="especie2"><?php 
echo $dadosboleto["especie"];
?></td>
            <td class="qtd2"><?php 
echo $dadosboleto["quantidade"];
